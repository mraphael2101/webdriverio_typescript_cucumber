 ...
 *  features that a class should have. 
 *  Interfaces should be adjectives but in some instances can be nouns 
 *  REMINDER: Interfaces has no implementation details at all where as abstract classes can be a mixture of both */ 
...
// Example 2: Interfaces can be applied to implement common behaviours and characteristics amongst a collection of classes
