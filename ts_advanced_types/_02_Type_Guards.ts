// A Type Guard is an approach to determine if a property exists/or if you can do something with the type before you try to use it
// Manipulate with either typeof, instanceof, or in keywords


// Example 1: A union is a type that can be one of many and is not fixed
 ...
 * Hence, we need to apply a type guard so that the code will compile in TS */
...
// Example 3: A more elegant way of applying a type guard for a union type is as follows:
