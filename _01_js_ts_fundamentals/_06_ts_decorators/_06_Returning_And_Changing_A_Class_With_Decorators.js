/* Replace the original class constructor function with a
...
function MyDecorator(template) {
    return function (original_constructor) {
...
var Demonstration = /** @class */ (function () {
    function Demonstration() {
        console.log("Creating Demonstration object");
    }
    Demonstration = __decorate([
        MyDecorator("Any text")
    ], Demonstration);
